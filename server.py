...
async def stock_time_series(
    ...
    interval: Annotated[str, Field(description="Data interval the ones mentioned as examples ahead are the ONLY intervals allowed,donot allow any other interval to pass, e.g. '1m','5m','15m','30m','1h','1d'")] = "1h",
